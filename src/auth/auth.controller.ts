...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      '通过 code 获取`access_token`https://open.feishu.cn/open-apis/authen/v1/index?app_id=cli_a25ba3dbda3a5013&redirect_uri=http%3A%2F%2F127.0.0.1%3A3001%2Fauth',
  })
  ...
  async getFeishuTokenByApplications(
    ...
    (response as any).setCookie('jwt', access_token, {
      path: '/',
    });
